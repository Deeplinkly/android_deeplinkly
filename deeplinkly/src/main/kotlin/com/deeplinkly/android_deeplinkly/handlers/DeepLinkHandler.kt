        ...
        try {
            ...
            SdkRuntime.ioLaunch {
                ...
                try {
                    ...
                    // Always enqueue for reliability (handles no listener yet,
                    // app restart, etc.)
                    DeepLinkQueue.enqueueDelivery(delivery)

                    // Delivered straight away when somebody is listening, and
                    // left in the queue for the processor when nobody is - the
                    // check lives inside deliverDeepLink, on the main thread,
                    // where the answer cannot go stale between test and use.
                    SdkRuntime.deliverDeepLink(delivery)

                    // Fire enrichment (respecting your "sendOnce" semantics)
                    com.deeplinkly.android_deeplinkly.attribution.EnrichmentSender
